...
class ReviewResponse(BaseModel):
    ...
    logic_results: list[dict] = Field(default_factory=list, description="Security/logic findings")
    fix_suggestions: list[dict] = Field(default_factory=list, description="Suggested fixes")
...
class WebhookResponse(BaseModel):
    ...
    action: Optional[str] = Field(None, description="GitHub action that triggered webhook")
